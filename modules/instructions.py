...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.btnResultado.setObjectName(u"btnResultado")
        self.btnResultado.setStyleSheet(u"font: 700 12pt \"Yu Gothic UI\";")

        self.gridLayout.addWidget(self.btnResultado, 3, 0, 1, 1)

        self.btnDef = QPushButton(self.gridLayoutWidget)
        self.btnDef.setObjectName(u"btnDef")
        self.btnDef.setStyleSheet(u"font: 700 12pt \"Yu Gothic UI\";")

        self.gridLayout.addWidget(self.btnDef, 3, 2, 1, 1)

        self.label_2 = QLabel(self.gridLayoutWidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setStyleSheet(u"font: 700 12pt \"Yu Gothic UI\";")

        self.gridLayout.addWidget(self.label_2, 1, 0, 1, 1)

        self.btnInit = QPushButton(self.gridLayoutWidget)
        self.btnInit.setObjectName(u"btnInit")
        self.btnInit.setStyleSheet(u"font: 700 12pt \"Yu Gothic UI\";")
        ...
        self.label_3.setStyleSheet(u"font: 700 12pt \"Yu Gothic UI\";")
        ...
        self.btnIngreso.setStyleSheet(u"font: 700 12pt \"Yu Gothic UI\";")
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(QCoreApplication.translate("Form", u"Instrucci\u00f3nes", None))
        self.btnResultado.setText(QCoreApplication.translate("Form", u"Resultado", None))
        self.btnDef.setText(QCoreApplication.translate("Form", u"Definici\u00f3n", None))
        self.label_2.setText(QCoreApplication.translate("Form", u"Ingreso/Resultado", None))
        self.btnInit.setText(QCoreApplication.translate("Form", u"Inicializaci\u00f3n", None))
        self.label_3.setText(QCoreApplication.translate("Form", u"Datos", None))
        self.btnIngreso.setText(QCoreApplication.translate("Form", u"Ingreso", None))
    # retranslateUi
